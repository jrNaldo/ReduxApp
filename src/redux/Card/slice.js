...
const cartSlice = createSlice({
    ...
    reducers:{ // Todas as actions do reducer
...
export const {addProduct, removeProduct,addQtdeProduct, decQtdeProduct} = cartSlice.actions
